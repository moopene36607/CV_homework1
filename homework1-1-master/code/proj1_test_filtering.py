...
print("It's could takes some time to compute all the outputs.")
''' set up '''
main_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
#size : 410*361 (i.e x=410 y=361)
img_path = main_path + '/data/cat.bmp'
test_image = mpimg.imread(img_path)
'''
print(test_image.size)          #410*361*3=444030
print(len(test_image))          #x=361
print(len(test_image[0]))       #y=410
print(len(test_image[0][0]))    #channel=3
'''
